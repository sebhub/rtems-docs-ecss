...
The Interface Control Document together with the Software Requirements
Specification ${doc-ts-srs:/cite} forms the Technical Specification as required by
...
Therefore, a survey was carried out in March 2019 those results were discussed
on an online workshop organized by ESA/ESTEC at 27th March 2019.  The initial
set of interfaces for the pre-qualified RTEMS feature set are documented in the
...
constraints are listed for each interface here in the ICD and also in the RTEMS
Classic API Guide ${/ref/rtems/c-user:/cite}.
