...
The unit and integration test plan and implementation are done using
specification items and the qualification tools.

Personnel and personnel training requirements
=============================================

Software engineers which fulfil the overall project training requirements are
