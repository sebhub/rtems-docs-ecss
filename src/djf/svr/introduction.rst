...
Design Justification File (DJF) as required by |E40| ${/ref/ecss/e-st-40c:/cite} and
|Q80| ${/ref/ecss/q-st-80c-r1:/cite}.  The document is intended to be used by
...
started by reading the Software Configuration File ${/pkg/deployment/doc-package-manual:/cite}.  For using
RTEMS in general, please refer to the |RUM| ${/ref/rtems/user:/cite} and the |RCA|
...
functionality.  A key element of the pre-qualified features set is the support
